...
import { $n as retrieve2, $t as createIntersectContext, A as ZRImage, An as inherits, At as applyTransform$1, Bn as isString, Bt as min, C as ZRText, Cn as each$2, Ct as quadraticAt, D as subPixelOptimize$1, Dt as Transformable, E as Rect, En as filter, Gn as map$1, Gt as sub, Hn as isTypedArray, Ht as scale$1, It as distance, Jn as mixin, Jt as calculateTextPosition, Kn as merge, Ln as isNumber, Mn as isArrayLike, N as Path, Nn as isDom, O as subPixelOptimizeLine$1, On as hasOwn, P as windingLine, Pn as isFunction, Qt as BoundingRect, R as PathProxy, Rn as isObject$2, S as Group, St as cubicSubdivide, Tn as extend, Tt as quadraticSubdivide, U as Eventful, Un as keys, V as Displayable, Vn as isStringSafe, Vt as normalize$1, Xn as normalizeCssArray$1, Yn as noop, Yt as getBoundingRect, Zn as reduce, Zt as parsePercent$1, _n as clone$1, an as invert, bn as curry, bt as cubicDerivativeAt, c as init$1, cr as setPlatformAPI, en as Point, er as retrieve3, fn as LRU, ft as liftColor, gn as bind, hn as assert, in as identity, jn as isArray, jt as clone, k as subPixelOptimizeRect$1, kn as indexOf, kt as add, l as registerPainter, mn as env, mt as modifyHSL, n as brushSingle, nn as copy, nr as slice, p as sort, pn as __extends$1, rn as create, rr as trim, sn as mul, sr as platformApi, tr as setAsPrimitive, u as registerSSRDataGetter, v as encodeHTML, vn as concatArray, wn as eqNaN, wt as quadraticDerivativeAt, x as CompoundPath, xn as defaults, yn as createHashMap, yt as cubicAt, zn as isRegExp, zt as max } from "./graphic-Bun-GxzQ.js";
...
function getPixelPrecision(dataExtent, pixelExtent) {
	...
	var sizeQuantity = Math.round(log(mathAbs$2(pixelExtent[1] - pixelExtent[0])) / LN10);
...
var LogScale = function(_super) {
	...
	*/
	...
	LogScale.prototype.setBreaksFromOption = function(breakOptionList) {
		...
		var _a = scaleBreakHelper.logarithmicParseBreaksFromOption(breakOptionList, this.base, bind(this.parse, this)), parsedOriginal = _a.parsedOriginal, parsedLogged = _a.parsedLogged;
...
//#endregion
export { registerTransform as $, getPrecisionSafe as $i, animateLabelValue as $n, Sector as $r, addCommas as $t, PRIORITY as A, interpolateRawValues as Ai, shouldOmitUnusedDimensions as An, retrieveZInfo as Ar, createTooltipMarkup as At, getMap as B, deprecateLog as Bi, isSourceInstance as Bn, removeElementWithFadeOut as Br, LOCATION_PARAMS as Bt, increaseInterval as C, clearTmpModel as Ci, injectCoordSysByOption as Cn, isBoundingRectAxisAligned as Cr, normalizeSymbolOffset as Ct, OrdinalMeta as D, getDataItemValue as Di, SeriesDataSchema as Dn, mergePath as Dr, defaultSeriesFormatTooltip as Dt, logTransform as E, defaultEmphasis as Ei, SeriesData as En, makePath as Er, SeriesModel as Et, disconnect as F, normalizeToArray as Fi, parseDataValue as Fn, traverseElements as Fr, disableTransformOptionMerge as Ft, registerLayout as G, throwError as Gi, SERIES_LAYOUT_BY_COLUMN as Gn, RadialGradient as Gr, fetchLayoutMode as Gt, registerAction as H, error as Hi, guessOrdinal as Hn, updateProps as Hr, box as Ht, dispose as I, parseFinder as Ii, SeriesDimensionDefine as In, traverseUpdateZ as Ir, DataFormatMixin as It, registerPostInit as J, asc as Ji, SOURCE_FORMAT_ORIGINAL as Jn, BezierCurve as Jr, getLayoutParams as Jt, registerLoading as K, warn as Ki, SOURCE_FORMAT_ARRAY_ROWS as Kn, LinearGradient as Kr, getBoxLayoutParams as Kt, getCoordinateSystemDimensions as L, preParseFinder as Li, getDimensionTypeByAxis as Ln, getAnimationConfig as Lr, normalizeTooltipFormatResult as Lt, dataTool as M, makeInner as Mi, SortOrderComparator as Mn, subPixelOptimize as Mr, retrieveVisualColorForTooltipMarker as Mt, dependencies as N, makeInternalComponentId as Ni, createFilterComparator as Nn, subPixelOptimizeLine as Nr, tokens as Nt, AxisModelCommonMixin as O, getTooltipRenderMode as Oi, createDimNameMap as On, registerShape as Or, TooltipMarkupStyleCreator as Ot, disConnect as P, mappingToExists as Pi, getRawValueParser as Pn, transformDirection as Pr, SourceManager as Pt, registerTheme as Q, getPrecision as Qi, LabelMarginType as Qn, Ring as Qr, sizeCalculable as Qt, getInstanceByDom as R, queryDataIndex as Ri, retrieveRawValue as Rn, initProps as Rr, getDecalFromPalette as Rt, OrdinalScale as S, SINGLE_REFERRING as Si, decideCoordSysUsageKind as Sn, groupTransition as Sr, createSymbol as St, isValueNice as T, convertOptionIdName as Ti, simpleCoordSysInjectionProvider as Tn, makeImage as Tr, symbolBuildProxies as Tt, registerCoordinateSystem as U, log as Ui, makeSeriesEncodeForAxisCoordSys as Un, IncrementalDisplayable as Ur, copyLayoutParams as Ut, init as V, deprecateReplaceLog as Vi, BE_ORDINAL as Vn, saveOldStyle as Vr, applyPreserveAspect as Vt, registerCustomSeries as W, makePrintable as Wi, makeSeriesEncodeForNameBased as Wn, OrientedBoundingRect as Wr, createBoxLayoutReference as Wt, registerPreprocessor as X, getPercentWithPrecision as Xi, DataDiffer as Xn, Polyline as Xr, mergeLayoutParam as Xt, registerPostUpdate as Y, getPercentSeats as Yi, VISUAL_DIMENSIONS as Yn, Line as Yr, getLayoutRect as Yt, registerProcessor as Z, getPixelPrecision as Zi, Model as Zn, Polygon as Zr, positionElement as Zt, shouldShowAllLabels as _, __extends as _a, toggleHoverEmphasis as _i, enableDataStack as _n, extendPath as _r, getLayoutOnAxis as _t, Axis as a, nice as aa, enableComponentHighDownFeatures as ai, getTooltipMarker as an, setLabelStyle as ar, createOrUpdatePatternFromDecal as at, TimeScale as b, ListIterator as bi, CoordinateSystemManager as bn, getTransform as br, createRenderPlanner as bt, createScaleByModel as c, parsePercent as ca, enterBlur as ci, windowOpen as cn, XY as cr, getVisualFromData as ct, getScaleExtent as d, quantity as da, leaveBlur as di, roundTime as dn, clipPointsByRect as dr, registerInternalOptionCreator as dt, isNumeric as ea, Ellipse as ei, capitalFirst as en, createTextConfig as er, registerUpdateLifecycle as et, ifAxisCrossZero as f, quantityExponent as fa, leaveEmphasis as fi, getScaleBreakHelper as fn, clipRectByRect as fr, createLegacyDataSelectAction as ft, shouldAxisShow as g, makeStyleMapper as ga, setStatesStylesFromModel as gi, inheritDefaultOption as gn, expandOrShrinkRect as gr, createProgressiveLayout as gt, retrieveAxisBreaksOption as h, round as ha, setStatesFlag as hi, getUID as hn, ensureCopyTransform as hr, throttle as ht, contain as i, mathMin$2 as ia, SPECIAL_STATES as ii, formatTplSimple as in, labelInner as ir, getCustomSeries as it, connect as j, isNameSpecified as ji, CtorInt32Array$1 as jn, setTooltipConfig as jr, getPaddingFromTooltipModel as jt, use as k, groupData as ki, ensureSourceDimNameMap as kn, resizePath as kr, buildTooltipMarkup as kt, getAxisRawValue as l, parsePositionSizeOption as la, enterEmphasis as li, getTextRect as ln, applyTransform as lr, setItemVisualFromData as lt, niceScaleExtent as m, remRadian as ma, setDefaultStateProxy as mi, registerLocale as mn, ensureCopyRect as mr, createOrUpdate as mt, GeoJSONRegion as n, linearMap as na, createFromString as ni, formatTime as nn, getFont as nr, setCanvasCreator as nt, AxisTickLabelComputingKind as o, numericToNumber as oa, enableHoverEmphasis as oi, normalizeCssArray as on, setLabelValueAnimation as or, findEventDispatcher as ot, isNameLocationCenter as p, reformIntervals as pa, setAsHighDownDispatcher as pi, getLocaleModel as pn, createIcon as pr, clear as pt, registerMap as q, MAX_SAFE_INTEGER as qi, SOURCE_FORMAT_OBJECT_ROWS as qn, Arc as qr, getCircleLayout as qt, GeoSVGRegion as r, mathMax$2 as ra, DISPLAY_STATES as ri, formatTpl as rn, getLabelStatesModels as rr, version as rt, createAxisLabelsComputingContext as s, parseDate as sa, enableHoverFocus as si, toCamelCase as sn, WH as sr, getItemVisualFromData as st, parseGeoJSON as t, isRadianAroundZero as ta, Circle as ti, convertToColorString as tn, createTextStyle as tr, registerVisual as tt, getDataDimensionsOnAxis as u, quantile as ua, isHighDownDispatcher as ui, format as un, calcZ2Range as ur, ComponentView as ut, unionAxisExtentFromData as v, getECData as vi, getStackedDimension as vn, extendShape as vr, layout as vt, isIntervalOrLogScale as w, compressBatches as wi, registerLayOutOnCoordSysUsage as wn, linePolygonIntersect as wr, normalizeSymbolSize as wt, IntervalScale as x, MULTIPLE_REFERRING as xi, CoordinateSystemUsageKind as xn, graphic_exports as xr, createFloat32Array as xt, ensureScaleRawExtentInfo as y, setCommonECData as yi, isDimensionStacked as yn, getShapeClass as yr, ChartView as yt, getInstanceById as z, queryReferringComponents as zi, createSourceFromSeriesDataOption as zn, removeElement as zr, ComponentModel as zt };

//# sourceMappingURL=parseGeoJson-BXNQnM8-.js.map