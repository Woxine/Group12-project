import { $r as Sector, Ar as retrieveZInfo, At as createTooltipMarkup, Bi as deprecateLog, Bt as LOCATION_PARAMS, Ci as clearTmpModel, Cn as injectCoordSysByOption, Ct as normalizeSymbolOffset, D as OrdinalMeta, Di as getDataItemValue, Dr as mergePath, Ei as defaultEmphasis, En as SeriesData, Fi as normalizeToArray, Fn as parseDataValue, Ft as disableTransformOptionMerge, Gi as throwError, Gn as SERIES_LAYOUT_BY_COLUMN, H as registerAction, Hi as error, Hr as updateProps$1, Ht as box, Ii as parseFinder$1, Ir as traverseUpdateZ, It as DataFormatMixin, Ji as asc$2, Jt as getLayoutParams, Ki as warn, Kr as LinearGradient, Kt as getBoxLayoutParams, Li as preParseFinder, Lt as normalizeTooltipFormatResult, Mi as makeInner, Mn as SortOrderComparator, Ni as makeInternalComponentId, Nn as createFilterComparator, Nr as subPixelOptimizeLine, Nt as tokens, O as AxisModelCommonMixin, Oi as getTooltipRenderMode, Ot as TooltipMarkupStyleCreator, Pi as mappingToExists, Pn as getRawValueParser, Pr as transformDirection, Pt as SourceManager, Qi as getPrecision, Qr as Ring, Qt as sizeCalculable, Ri as queryDataIndex, Rt as getDecalFromPalette, S as OrdinalScale, Si as SINGLE_REFERRING, Sr as groupTransition, St as createSymbol, Ti as convertOptionIdName, Tn as simpleCoordSysInjectionProvider, Tt as symbolBuildProxies, Ut as copyLayoutParams, Wi as makePrintable, Wt as createBoxLayoutReference, Xn as DataDiffer, Xr as Polyline, Xt as mergeLayoutParam, Yr as Line, Yt as getLayoutRect, Zi as getPixelPrecision, Zn as Model, Zr as Polygon, Zt as positionElement, _a as __extends, _i as toggleHoverEmphasis, a as Axis, ar as setLabelStyle, at as createOrUpdatePatternFromDecal, b as TimeScale, bi as ListIterator, br as getTransform, c as createScaleByModel$1, ca as parsePercent, ci as enterBlur, cn as windowOpen, cr as XY$2, ct as getVisualFromData, di as leaveBlur, dt as registerInternalOptionCreator, fi as leaveEmphasis, gi as setStatesStylesFromModel, gn as inheritDefaultOption, gr as expandOrShrinkRect, hn as getUID, i as contain, ia as mathMin$1, in as formatTplSimple, ji as isNameSpecified, jr as setTooltipConfig, jt as getPaddingFromTooltipModel, k as use, kt as buildTooltipMarkup, l as getAxisRawValue, la as parsePositionSizeOption, li as enterEmphasis, lr as applyTransform, lt as setItemVisualFromData, m as niceScaleExtent, mt as createOrUpdate, na as linearMap$2, nr as getFont, oi as enableHoverEmphasis, on as normalizeCssArray, ot as findEventDispatcher, pa as reformIntervals, pi as setAsHighDownDispatcher, pn as getLocaleModel, pr as createIcon, pt as clear$1, ra as mathMax$1, rn as formatTpl, rr as getLabelStatesModels, sa as parseDate, sn as toCamelCase, sr as WH$2, st as getItemVisualFromData, ti as Circle, tn as convertToColorString, tr as createTextStyle, u as getDataDimensionsOnAxis, un as format, ur as calcZ2Range, ut as ComponentView, v as unionAxisExtentFromData, vi as getECData, vn as getStackedDimension, wi as compressBatches, wr as linePolygonIntersect, wt as normalizeSymbolSize, x as IntervalScale, xi as MULTIPLE_REFERRING, xr as graphic_exports, y as ensureScaleRawExtentInfo, yn as isDimensionStacked, yr as getShapeClass, zi as queryReferringComponents, zt as ComponentModel } from "./parseGeoJson-BXNQnM8-.js";
import { $n as retrieve2, A as ZRImage, At as applyTransform$1, Bn as isString, C as ZRText, Cn as each$9, D as subPixelOptimize, E as Rect$1, En as filter, Gn as map, Jn as mixin, Kn as merge, Ln as isNumber, Mn as isArrayLike, Nn as isDom, On as hasOwn, Pn as isFunction, Qn as retrieve, Qt as BoundingRect, Rn as isObject, S as Group$2, Tn as extend, Un as keys, V as Displayable, Wn as logError, Wt as set, Yn as noop, Yt as getBoundingRect, Zt as parsePercent$1, _ as stop, _n as clone$1, _t as stringify, an as invert, b as transformLocalCoordClear, bn as curry$1, cn as rotate, en as Point, g as normalizeEvent, gn as bind$1, hn as assert, ht as parse, jn as isArray$1, kn as indexOf, m as addEventListener, mn as env, pt as modifyAlpha, qn as mergeAll, rn as create$1, rr as trim$1, sn as mul, un as translate, v as encodeHTML, wn as eqNaN, xn as defaults, y as transformLocalCoord, yn as createHashMap, zn as isRegExp } from "./graphic-Bun-GxzQ.js";
import { B as layout$1, C as install$8, F as rectCoordAxisHandleRemove, H as axisModelCreator, I as AxisView, K as isCoordinateSystemType, L as collect, M as install$21, N as install$11, P as rectCoordAxisBuildSplitArea, R as getAxisInfo$1, S as VisualMapping, U as getAxisBreakHelper, V as AxisBuilder, a as isTransitionAll, d as install$19, f as makeLinearBrushOtherExtent, g as sliderMove, h as BrushController, i as applyUpdateTransition, j as RoamController, l as isEC4CompatibleStyle, m as makeRectPanelClipPath, n as stopPreviousKeyframeAnimationAndRestore, o as updateLeaveTo, p as makeRectIsTargetByCursor, q as SymbolDraw, r as applyLeaveTransition, s as convertFromEC4CompatibleStyle, t as applyKeyframeAnimation, v as injectThumbnailBridge, w as View, y as LineDraw, z as makeKey } from "./customGraphicKeyframeAnimation-otyBC7n7.js";
...
var MatrixDim = function() {
	...
	MatrixDim.prototype._initByDimModelData = function(dimModelData) {
		...
		function traverseInitCells(dimModelData, firstLeafLocator, level) {
			...
			each$9(dimModelData, function(option, optionIdx) {
	...
	MatrixDim.prototype._initCellsId = function() {
		var levelsLen = this._levels.length;
		var dimIdx = this.dimIdx;
		each$9(this._cells, function(cell) {
			setDimXYValue(cell.id, dimIdx, cell.firstLeafLocator, cell.level - levelsLen);
		});
	};
	MatrixDim.prototype._initLevelIdOptions = function() {
		...
		each$9(this._levels, function(levelCfg, level) {
	...
	*/
	MatrixBodyCorner.prototype._ensureCellMap = function() {
		...
		function fillCellMap() {
			...
			each$9(cellOptionList, function(option, idx) {
			...
			each$9(parsedList, function(parsed) {
...
var ToolboxModel = function(_super) {
	...
	ToolboxModel.defaultOption = {
		...
		emphasis: { iconStyle: { borderColor: tokens.color.accent50 } },
		tooltip: {
			show: false,
			position: "bottom"
		}
