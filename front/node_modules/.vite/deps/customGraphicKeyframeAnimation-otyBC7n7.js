import { $i as getPrecisionSafe, Ar as retrieveZInfo, C as increaseInterval, Cn as injectCoordSysByOption, Cr as isBoundingRectAxisAligned, Ct as normalizeSymbolOffset, D as OrdinalMeta, Dr as mergePath, E as logTransform, Ei as defaultEmphasis, Fi as normalizeToArray, Fr as traverseElements, Gr as RadialGradient, Gt as fetchLayoutMode, H as registerAction, Hi as error, Hr as updateProps, Ji as asc, Jr as BezierCurve, Jt as getLayoutParams, Ki as warn, Kr as LinearGradient, Lr as getAnimationConfig, Mi as makeInner, Nr as subPixelOptimizeLine, Nt as tokens, O as AxisModelCommonMixin, Pr as transformDirection, Qn as LabelMarginType, Qr as Ring, Rn as retrieveRawValue, Rr as initProps, Si as SINGLE_REFERRING, Sr as groupTransition, St as createSymbol$1, T as isValueNice, Ui as log, Vr as saveOldStyle, Vt as applyPreserveAspect, Wr as OrientedBoundingRect, Wt as createBoxLayoutReference, Xn as DataDiffer, Xr as Polyline, Xt as mergeLayoutParam, Yr as Line$1, Yt as getLayoutRect, Zn as Model, Zr as Polygon, _ as shouldShowAllLabels, _a as __extends, _i as toggleHoverEmphasis, a as Axis, ai as enableComponentHighDownFeatures, ar as setLabelStyle, at as createOrUpdatePatternFromDecal, br as getTransform$1, c as createScaleByModel, ca as parsePercent, cr as XY, d as getScaleExtent, dr as clipPointsByRect, ei as Ellipse, f as ifAxisCrossZero, fi as leaveEmphasis, fn as getScaleBreakHelper, g as shouldAxisShow, ga as makeStyleMapper, gr as expandOrShrinkRect, h as retrieveAxisBreaksOption, ha as round$1, hn as getUID, hr as ensureCopyTransform, ii as SPECIAL_STATES, jr as setTooltipConfig, la as parsePositionSizeOption, li as enterEmphasis, lr as applyTransform, m as niceScaleExtent, ma as remRadian, mi as setDefaultStateProxy, mr as ensureCopyRect, mt as createOrUpdate, n as GeoJSONRegion, na as linearMap, ni as createFromString, o as AxisTickLabelComputingKind, ot as findEventDispatcher, p as isNameLocationCenter, pt as clear, r as GeoSVGRegion, ra as mathMax$2, rr as getLabelStatesModels, s as createAxisLabelsComputingContext, sr as WH, t as parseGeoJSON, ta as isRadianAroundZero, ti as Circle, tr as createTextStyle, u as getDataDimensionsOnAxis, ut as ComponentView, vi as getECData, w as isIntervalOrLogScale, wt as normalizeSymbolSize, x as IntervalScale, zr as removeElement, zt as ComponentModel } from "./parseGeoJson-BXNQnM8-.js";
import { $n as retrieve2, A as ZRImage, At as applyTransform$1, Bn as isString, Bt as min, C as ZRText, Cn as each$2, Dn as find, Dt as Transformable, E as Rect, En as filter, Et as TRANSFORMABLE_PROPS, Gn as map, Gt as sub, Jn as mixin, Kn as merge, Ln as isNumber, Mn as isArrayLike, Mt as copy$1, N as Path, On as hasOwn, Ot as copyTransform, Pn as isFunction, Qn as retrieve, Qt as BoundingRect, Rn as isObject$1, S as Group, Tn as extend, U as Eventful, Un as keys, V as Displayable, Vt as normalize, W as cloneValue, Yn as noop, Zn as reduce, _ as stop, _n as clone, _t as stringify, an as invert, bn as curry, cn as rotate, en as Point, er as retrieve3, gn as bind, gt as parseCssFloat, h as isMiddleOrRightButtonOnMouseUpDown, hn as assert, ht as parse, in as identity, j as TSpan, jn as isArray, kn as indexOf, ln as scale, lt as fastLerp, mt as modifyHSL, nn as copy, pt as modifyAlpha, qn as mergeAll, rn as create, rr as trim, sn as mul, un as translate, wn as eqNaN, x as CompoundPath, xn as defaults, yn as createHashMap, zt as max } from "./graphic-Bun-GxzQ.js";
...
function resetOverlapRecordToShared(cfg, shared, axisModel, labelLayoutList) {
	...
	each$2(labelLayoutList, function(layout) {
...
var AxisBuilder = function() {
	...
	*/
	...
	AxisBuilder.prototype.build = function(axisPartNameMap, extraParams) {
		...
		each$2(AXIS_BUILDER_AXIS_PART_NAMES, function(partName) {
...
function syncLabelIgnoreToMajorTicks(cfg, labelLayoutList, tickEls) {
	...
	each$2(labelLayoutList, function(labelLayout) {
...
function updateAxisLabelChangableProps(cfg, axisModel, labelLayoutList, transformGroup) {
	...
	each$2(labelLayoutList, function(layout, idx) {
...
function adjustBreakLabels(axisModel, axisRotation, labelLayoutList) {
	...
	if (moveOverlap === true || moveOverlap === "auto") each$2(breakLabelIndexPairs, function(idxPair) {
...
function updateCartesianAxisViewCommonPartBuilder(axisBuilder, gridRect, axisModel) {
	...
	each$2(keys(newRaw), function(prop) {
...
function layOutGridByOuterBounds(outerBoundsRect, outerBoundsContain, outerBoundsClamp, gridRect, axesMap, axisBuilderSharedCtx, layoutRef) {
	...
	function fillLabelNameOverflowOnOneDimension(xyIdx) {
		each$2(axesMap[XY[xyIdx]], function(axis) {
...
var VisualMapping = function() {
	...
	*/
	VisualMapping.retrieveVisuals = function(obj) {
		var ret = {};
		var hasVisual;
		obj && each$1(VisualMapping.visualHandlers, function(h, visualType) {
...
function preprocessForSpecifiedCategory(thisOption) {
	...
	if (!isArray(visual)) {
		var visualArr_1 = [];
		if (isObject$1(visual)) each$1(visual, function(v, cate) {
...
function normalizeVisualRange(thisOption, isCategory) {
	var visual = thisOption.visual;
	var visualArr = [];
	if (isObject$1(visual)) each$1(visual, function(v) {
		visualArr.push(v);
	});
...
//#endregion
export { updateViewOnZoom as A, layout as B, install$1 as C, updateCenterAndZoomInAction as D, geoSourceManager_default as E, rectCoordAxisHandleRemove as F, shiftLayoutOnXY as G, axisModelCreator as H, AxisView as I, Symbol as J, isCoordinateSystemType as K, collect as L, install$2 as M, install$3 as N, updateController as O, rectCoordAxisBuildSplitArea as P, getAxisInfo as R, VisualMapping as S, MapDraw as T, getAxisBreakHelper as U, AxisBuilder as V, computeLabelGeometry as W, getDefaultLabel as X, getDefaultInterpolatedLabel as Y, getThumbnailBridge as _, isTransitionAll as a, Line as b, convertToEC4StyleForCustomSerise as c, install as d, makeLinearBrushOtherExtent as f, sliderMove as g, BrushController as h, applyUpdateTransition as i, RoamController as j, updateViewOnPan as k, isEC4CompatibleStyle as l, makeRectPanelClipPath as m, stopPreviousKeyframeAnimationAndRestore as n, updateLeaveTo as o, makeRectIsTargetByCursor as p, SymbolDraw as q, applyLeaveTransition as r, convertFromEC4CompatibleStyle as s, applyKeyframeAnimation as t, warnDeprecated as u, injectThumbnailBridge as v, View as w, ECLinePath as x, LineDraw as y, makeKey as z };

//# sourceMappingURL=customGraphicKeyframeAnimation-otyBC7n7.js.map