...
var BoundingRect = function() {
	...
	BoundingRect.intersect = function(a, b, mtv, opt) {
		...
		if (useMTV || outIntersectRect) {
			...
			if (useMTV) Point.copy(mtv, overlap ? _intersectCtx.useDir ? _intersectCtx.dirMinTv : _minTv : _maxTv);
		}
		return overlap;
	};
...
//#endregion
export { hasShadow as $, retrieve2 as $n, createIntersectContext as $t, ZRImage as A, inherits as An, applyTransform as At, fromPoints as B, isString as Bn, min$1 as Bt, ZRText as C, each as Cn, quadraticAt as Ct, subPixelOptimize as D, find as Dn, Transformable as Dt, Rect as E, filter as En, TRANSFORMABLE_PROPS as Et, normalizeRadian as F, isGradientObject as Fn, distSquare as Ft, TEXT_ALIGN_TO_ANCHOR as G, map as Gn, sub as Gt, devicePixelRatio as H, isTypedArray as Hn, scale as Ht, containStroke$2 as I, isImagePatternObject as In, distance as It, getIdURL as J, mixin as Jn, calculateTextPosition as Jt, adjustTextY as K, merge as Kn, vector_exports as Kt, containStroke$4 as L, isNumber as Ln, len as Lt, DEFAULT_PATH_STYLE as M, isArrayLike as Mn, copy as Mt, Path as N, isDom as Nn, create as Nt, subPixelOptimizeLine as O, hasOwn as On, copyTransform as Ot, windingLine as P, isFunction as Pn, dist$1 as Pt, getShadowKey as Q, retrieve as Qn, BoundingRect as Qt, PathProxy as R, isObject as Rn, lerp$1 as Rt, Group as S, disableUserSelect as Sn, cubicSubdivide as St, parseFontSize as T, extend as Tn, quadraticSubdivide as Tt, Eventful as U, keys as Un, scaleAndAdd as Ut, Displayable as V, isStringSafe as Vn, normalize as Vt, cloneValue as W, logError as Wn, set as Wt, getPathPrecision as X, normalizeCssArray as Xn, getLineHeight as Xt, getMatrixStr as Y, noop as Yn, getBoundingRect as Yt, getSRTTransformString as Z, reduce as Zn, parsePercent as Zt, stop as _, clone$2 as _n, stringify as _t, getCanvasGradient as a, invert as an, DEFAULT_FONT as ar, isRadialGradient as at, transformLocalCoordClear as b, curry as bn, cubicDerivativeAt as bt, init as c, rotate as cn, setPlatformAPI as cr, color_exports as ct, zrender_exports as d, createOrUpdateImage as dn, lift as dt, Point as en, retrieve3 as er, isAroundZero as et, requestAnimationFrame as f, LRU as fn, liftColor as ft, normalizeEvent as g, bind as gn, parseCssFloat as gt, isMiddleOrRightButtonOnMouseUpDown as h, assert as hn, parse as ht, getLineDash as i, identity as in, util_exports as ir, isPattern as it, TSpan as j, isArray as jn, clone as jt, subPixelOptimizeRect as k, indexOf as kn, add as kt, registerPainter as l, scale$1 as ln, fastLerp as lt, addEventListener as m, env as mn, modifyHSL as mt, brushSingle as n, copy$1 as nn, slice as nr, isImagePattern as nt, getSize as o, matrix_exports as on, DEFAULT_FONT_FAMILY as or, normalizeColor as ot, sort as p, __extends as pn, modifyAlpha as pt, encodeBase64 as q, mergeAll as qn, truncateText as qt, createCanvasPattern as r, create$1 as rn, trim as rr, isLinearGradient as rt, getElementSSRData as s, mul$1 as sn, platformApi as sr, round4 as st, brush as t, clone$1 as tn, setAsPrimitive as tr, isGradient as tt, registerSSRDataGetter as u, translate as un, lerp as ut, encodeHTML as v, concatArray as vn, createCubicEasingFunc as vt, hasSeparateFont as w, eqNaN as wn, quadraticDerivativeAt as wt, CompoundPath as x, defaults as xn, cubicRootAt as xt, transformLocalCoord as y, createHashMap as yn, cubicAt as yt, normalizeArcAngles as z, isRegExp as zn, max$1 as zt };

//# sourceMappingURL=graphic-Bun-GxzQ.js.map