            ...
            val fetchScooters = fun(fromPullRefresh: Boolean){
                ...
                uni_request<Any>(RequestOptions(url = BASE_URL + "/api/v1/scooters", method = "GET", success = fun(res){
                    ...
                    if (ok) {
                        ...
                        val dataArr = raw.getArray<UTSJSONObject>("data")
                        val scootersArr = raw.getArray<UTSJSONObject>("scooters")
                        val listArr = raw.getArray<UTSJSONObject>("list")
                        if (dataArr != null) {
                            arr = dataArr
