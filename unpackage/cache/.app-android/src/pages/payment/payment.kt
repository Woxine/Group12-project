...
open class GenPagesPaymentPayment : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesPaymentPayment) -> Any? = fun(__props): Any? {
            ...
            val onCancel = fun(){
                uni_reLaunch(ReLaunchOptions(url = "/pages/bikelist/bikelist"))
            }
            return fun(): Any? {
                return _cE("view", _uM("class" to "back"), _uA(
