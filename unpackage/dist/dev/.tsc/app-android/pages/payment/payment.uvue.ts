...
// 支付方式列表
type PaymentInfo = { __$originalPosition?: UTSSourceMapPosition<"PaymentInfo", "pages/payment/payment.uvue", 162, 6>;
	cardNumber: string
	cardPassword: string
...
return (): any | null => {
  ...
  return _cE("view", _uM({ class: "back" }), [
    _cE("image", _uM({
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "payment_container" }), [
        ...
        _cE("button", _uM({
          ...
          class: _nC(['payment_button', isPaymentProcessing.value ? 'payment_button_disabled' : '', isPaymentProcessing.value ? 'processing' : '']),
