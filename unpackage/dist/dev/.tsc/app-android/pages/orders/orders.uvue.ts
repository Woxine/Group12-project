...
type Booking = { __$originalPosition?: UTSSourceMapPosition<"Booking", "pages/orders/orders.uvue", 97, 6>;
	id: string | null
	scooterId: string
	duration: string
	startTime: string
...
type BookingsResult = { __$originalPosition?: UTSSourceMapPosition<"BookingsResult", "pages/orders/orders.uvue", 111, 6>;
	list: Booking[]
	totalCount: number
}
...
const hasActiveBookings = (): boolean => {
	...
	for (let i = 0; i < list.length; i++) {
		...
		if (s === 'CONFIRMED' || s === 'PENDING') return true
	}
	return false
}
...
const fetchBookings = (fromPullRefresh: boolean) => {
	...
	uni.request({
		url: BASE_URL + '/api/v1/users/' + userId + '/bookings?page=1&size=' + PAGE_SIZE,
		method: 'GET',
		header: {
...
const loadMore = () => {
	...
	uni.request({
		url: BASE_URL + '/api/v1/users/' + userId + '/bookings?page=' + nextPage + '&size=' + PAGE_SIZE,
		method: 'GET',
		header: {
			'Content-Type': 'application/json',
			'Authorization': 'Bearer ' + token
...
const hasRoute = (booking: Booking): boolean => {
	const slat = booking.startLat
	const slng = booking.startLng
	const elat = booking.endLat
	const elng = booking.endLng
		...
		success: (res) => {
			...
			if (confirm) {
				const doCancel = (endLatVal: number | null, endLngVal: number | null) => {
					const body: UTSJSONObject = {__$originalPosition: new UTSSourceMapPosition("body", "pages/orders/orders.uvue", 384, 12),}
	...
	uni.getLocation({
		...
		success: (loc) => {
			uni.request({
				...
				success: (resp) => {
					if (resp.statusCode >= 200 && resp.statusCode < 300) {
						uni.showToast({ title: 'Ride ended', icon: 'success' })
						fetchBookings(false)
					} else {
		...
		fail: () => {
			uni.showToast({ title: 'Location unavailable, cannot end ride', icon: 'none' })
		}
	})
}
                        ...
                        return _cE("view", _uM({
                          ...
                          _cE("view", _uM({ class: "card-body" }), [
                            ...
                            isTrue(canCancel(booking.status))
                              ...
                              : _cC("v-if", true),
                            isTrue(isCompleted(booking.status) || isCancelled(booking.status))
                              ? _cE("view", _uM({
                                  key: 1,
                                  class: "card-actions"
                                }), [
                                  ...
                                  }), "View Route", 8 /* PROPS */, ["onClick"])
                                ])
                              : _cC("v-if", true)
                          ])
                        ])
                      }), 128 /* KEYED_FRAGMENT */),
                      isTrue(hasMore.value)
                        ? _cE("view", _uM({
                            key: 0,
                            ...
                            isTrue(loadingMore.value)
                              ? _cE("button", _uM({
                                  key: 0,
                                  class: _nC(['load-more-btn', 'load-more-btn-disabled']),
                                  disabled: ""
                                }), "Loading...")
                              : _cE("button", _uM({
                                  key: 1,
...
const GenPagesOrdersOrdersStyles = [_uM([["container", _pS(_uM([["width", "100%"], ["height", "100%"], ["display", "flex"], ["flexDirection", "column"], ["backgroundColor", "#f5f5f5"], ["boxSizing", "border-box"]]))], ["login-prompt", _pS(_uM([["display", "flex"], ["flexDirection", "column"], ["alignItems", "center"], ["justifyContent", "center"], ["paddingTop", 60], ["paddingRight", 24], ["paddingBottom", 60], ["paddingLeft", 24]]))], ["icon-large", _pS(_uM([["width", 80], ["height", 80], ["opacity", 0.6], ["marginBottom", 24]]))], ["prompt-text", _pS(_uM([["fontSize", 16], ["color", "#666666"], ["marginBottom", 24], ["textAlign", "center"]]))], ["login-btn", _pS(_uM([["width", 200], ["height", 44], ["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 16], ["fontWeight", "bold"]]))], ["scroll-wrap", _pS(_uM([["width", "100%"]]))], ["scroll-area", _pS(_uM([["width", "100%"], ["paddingTop", 20], ["paddingRight", 20], ["paddingBottom", 40], ["paddingLeft", 20], ["boxSizing", "border-box"]]))], ["title-section", _pS(_uM([["marginBottom", 20]]))], ["title-text", _pS(_uM([["fontSize", 22], ["fontWeight", "bold"], ["color", "#333333"]]))], ["loading-section", _pS(_uM([["paddingTop", 40], ["paddingRight", 20], ["paddingBottom", 40], ["paddingLeft", 20], ["textAlign", "center"]]))], ["error-section", _pS(_uM([["paddingTop", 40], ["paddingRight", 20], ["paddingBottom", 40], ["paddingLeft", 20], ["textAlign", "center"]]))], ["loading-text", _pS(_uM([["fontSize", 14], ["color", "#999999"]]))], ["error-text", _pS(_uM([["fontSize", 14], ["color", "#f44336"], ["display", "flex"], ["flexDirection", "column"], ["marginBottom", 16]]))], ["retry-btn", _pS(_uM([["paddingTop", 10], ["paddingRight", 24], ["paddingBottom", 10], ["paddingLeft", 24], ["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14], ["fontWeight", "bold"]]))], ["empty-section", _pS(_uM([["display", "flex"], ["flexDirection", "column"], ["alignItems", "center"], ["justifyContent", "center"], ["paddingTop", 60], ["paddingRight", 24], ["paddingBottom", 60], ["paddingLeft", 24], ["backgroundColor", "#FFFFFF"], ["borderTopLeftRadius", 12], ["borderTopRightRadius", 12], ["borderBottomRightRadius", 12], ["borderBottomLeftRadius", 12], ["boxShadow", "0 2px 8px rgba(0, 0, 0, 0.08)"]]))], ["empty-text", _pS(_uM([["fontSize", 18], ["fontWeight", "bold"], ["color", "#333333"], ["marginBottom", 8]]))], ["empty-hint", _pS(_uM([["fontSize", 14], ["color", "#999999"], ["marginBottom", 24], ["textAlign", "center"]]))], ["explore-btn", _pS(_uM([["paddingTop", 12], ["paddingRight", 32], ["paddingBottom", 12], ["paddingLeft", 32], ["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14], ["fontWeight", "bold"]]))], ["bookings-list", _pS(_uM([["display", "flex"], ["flexDirection", "column"]]))], ["load-more-wrap", _pS(_uM([["marginTop", 8], ["marginBottom", 24], ["textAlign", "center"]]))], ["load-more-btn", _pS(_uM([["paddingTop", 10], ["paddingRight", 28], ["paddingBottom", 10], ["paddingLeft", 28], ["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14]]))], ["load-more-btn-disabled", _pS(_uM([["opacity", 0.7]]))], ["booking-card", _pS(_uM([["backgroundColor", "#FFFFFF"], ["borderTopLeftRadius", 12], ["borderTopRightRadius", 12], ["borderBottomRightRadius", 12], ["borderBottomLeftRadius", 12], ["paddingTop", 16], ["paddingRight", 16], ["paddingBottom", 16], ["paddingLeft", 16], ["marginBottom", 16], ["boxShadow", "0 2px 8px rgba(0, 0, 0, 0.08)"]]))], ["card-header", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "space-between"], ["alignItems", "center"], ["marginBottom", 12], ["paddingBottom", 10], ["borderBottomWidth", 1], ["borderBottomStyle", "solid"], ["borderBottomColor", "#eeeeee"]]))], ["booking-id", _pS(_uM([["fontSize", 16], ["fontWeight", "bold"], ["color", "#333333"]]))], ["status-badge", _pS(_uM([["fontSize", 12], ["paddingTop", 4], ["paddingRight", 10], ["paddingBottom", 4], ["paddingLeft", 10], ["borderTopLeftRadius", 6], ["borderTopRightRadius", 6], ["borderBottomRightRadius", 6], ["borderBottomLeftRadius", 6], ["fontWeight", "bold"]]))], ["status-Confirmed", _pS(_uM([["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"]]))], ["status-Pending", _pS(_uM([["backgroundColor", "#FFC107"], ["color", "#333333"]]))], ["status-Cancelled", _pS(_uM([["backgroundColor", "#f44336"], ["color", "#FFFFFF"]]))], ["status-Completed", _pS(_uM([["backgroundColor", "#2196F3"], ["color", "#FFFFFF"]]))], ["status-Unknown", _pS(_uM([["backgroundColor", "#9E9E9E"], ["color", "#FFFFFF"]]))], ["card-body", _pS(_uM([["display", "flex"], ["flexDirection", "column"]]))], ["card-actions", _pS(_uM([["marginTop", 12], ["paddingTop", 10], ["borderTopWidth", 1], ["borderTopStyle", "solid"], ["borderTopColor", "#eeeeee"], ["display", "flex"], ["flexDirection", "column"], ["gap", "8px"]]))], ["end-ride-btn", _pS(_uM([["width", "100%"], ["paddingTop", 10], ["paddingRight", 16], ["paddingBottom", 10], ["paddingLeft", 16], ["backgroundColor", "#4CAF50"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14], ["fontWeight", "bold"]]))], ["cancel-order-btn", _pS(_uM([["width", "100%"], ["paddingTop", 10], ["paddingRight", 16], ["paddingBottom", 10], ["paddingLeft", 16], ["backgroundColor", "#f44336"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14], ["fontWeight", "bold"]]))], ["view-route-btn", _pS(_uM([["width", "100%"], ["paddingTop", 10], ["paddingRight", 16], ["paddingBottom", 10], ["paddingLeft", 16], ["backgroundColor", "#2196F3"], ["color", "#FFFFFF"], ["borderTopWidth", "medium"], ["borderRightWidth", "medium"], ["borderBottomWidth", "medium"], ["borderLeftWidth", "medium"], ["borderTopStyle", "none"], ["borderRightStyle", "none"], ["borderBottomStyle", "none"], ["borderLeftStyle", "none"], ["borderTopColor", "#000000"], ["borderRightColor", "#000000"], ["borderBottomColor", "#000000"], ["borderLeftColor", "#000000"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["fontSize", 14], ["fontWeight", "bold"], ["marginTop", 8]]))], ["detail-row", _pS(_uM([["display", "flex"], ["flexDirection", "row"], ["justifyContent", "space-between"], ["fontSize", 14], ["marginBottom", 6]]))], ["label", _uM([[".detail-row ", _uM([["color", "#999999"]])]])], ["value", _uM([[".detail-row ", _uM([["color", "#333333"], ["fontWeight", "400"]])]])]])]
