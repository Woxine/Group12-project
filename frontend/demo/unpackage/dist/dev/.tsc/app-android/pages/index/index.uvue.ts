	...
	const getCurrentLocation = () => {
	  uni.getLocation({
	    ...
	    success: (res) => {
	      ...
	      longitude.value = lng
	      latitude.value = lat
	      const temp = UTSAndroid.consoleDebugError(JSON.parse<Marker[]>(JSON.stringify([{
	        id: 1,
	        longitude: lng,
	        latitude: lat,
	        title: '我的位置',
