...
type Scooter = { __$originalPosition?: UTSSourceMapPosition<"Scooter", "pages/bikelist/bikelist.uvue", 56, 6>;
	id: string
	battery: number
	location: string
}

// 滑板车列表（id 从 1 到 5，对应后端 scooters 表中的主键）
...
const scooterList = ref<Scooter[]>([
	{ id: '1', battery: 95, location: 'Market St' },
	{ id: '2', battery: 87, location: 'Central Park' },
	{ id: '3', battery: 72, location: 'Main Ave' },
	{ id: '4', battery: 88, location: 'Station Plaza' },
	{ id: '5', battery: 91, location: 'City Center' }
]);
...
const _component_navigator = resolveComponent("navigator")
  ...
  return _cE("view", _uM({ class: "page-wrapper" }), [
    _cE("scroll-view", _uM({
      ...
      _cE(Fragment, null, RenderHelpers.renderList(scooterList.value, (scooter, index, __index, _cached): any => {
        return _cE("view", _uM({
          key: index,
          class: "scooter-card"
        }), [
          ...
          _cE("view", _uM({ class: "card-content" }), [
            ...
            _cE("text", _uM({ class: "scooter-status" }), "Battery: " + _tD(scooter.battery) + "%", 1 /* TEXT */),
            _cE("text", _uM({ class: "scooter-location" }), "Location: " + _tD(scooter.location), 1 /* TEXT */)
          ]),
          _cE("view", _uM({
