...
open class GenPagesAdminModify : BasePage {
    constructor(__ins: ComponentInternalInstance, __renderer: String?) : super(__ins, __renderer) {}
    companion object {
        @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
        var setup: (__props: GenPagesAdminModify) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenPagesAdminModify
            ...
            val onSubmit = fun(){
                ...
                uni_request<Any>(RequestOptions(url = buildApiUrl("/api/v1/scooters/" + idStr), method = "PUT", data = body, header = object : UTSJSONObject() {
