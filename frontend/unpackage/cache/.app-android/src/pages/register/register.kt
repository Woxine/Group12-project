...
open class GenPagesRegisterRegister : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesRegisterRegister) -> Any? = fun(__props): Any? {
            ...
            val serverUrl = "http://192.168.16.2:8080/api/v1/users"
            ...
            val handleRegister = fun(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        val payload: UTSJSONObject = object : UTSJSONObject(UTSSourceMapPosition("payload", "pages/register/register.uvue", 161, 8)) {
                        ...
                        try {
                            ...
                            uni_request<Any>(RequestOptions(url = serverUrl, method = "POST", data = payload, header = object : UTSJSONObject() {
                                ...
                                if (response.statusCode >= 200 && response.statusCode < 300) {
                                    val result = response.data as UTSJSONObject
                                    console.log("Registration successful:", result, " at pages/register/register.uvue:186")
                                    val nameValue = result["name"]
                                    val welcomeName = if ((nameValue != null)) {
                                        nameValue.toString()
                                    } else {
                                        formData.value.name
                                    }
                    ...
                    _cE("view", _uM("class" to "back"), _uA(
                        ...
                        _cE("view", _uM("class" to "login_container"), _uA(
                            ...
                            _cE("view", _uM("class" to "validation-info"), _uA(
                                _cE("text", _uM("class" to _nC(_uM("valid" to isNameValid.value, "invalid" to (formData.value.name != "" && !isNameValid.value)))), _tD(if (formData.value.name != "") {
                                    if (isNameValid.value) {
                                        "✓ Name is valid"
                                    } else {
                                ...
                                _cE("text", _uM("class" to _nC(_uM("valid" to isEmailValid.value, "invalid" to (formData.value.email != "" && !isEmailValid.value)))), _tD(if (formData.value.email != "") {
                                    if (isEmailValid.value) {
                                        "✓ Valid email format"
                                    } else {
                                ...
                                _cE("text", _uM("class" to _nC(_uM("valid" to isPasswordValid.value, "invalid" to (formData.value.password != "" && !isPasswordValid.value)))), _tD(if (formData.value.password != "") {
                                    if (isPasswordValid.value) {
                                ...
                                _cE("text", _uM("class" to _nC(_uM("valid" to passwordsMatch.value, "invalid" to (confirmPassword.value != "" && !passwordsMatch.value)))), _tD(if (confirmPassword.value != "") {
                                    if (passwordsMatch.value) {
                                        "✓ Passwords match"
                                    } else {
