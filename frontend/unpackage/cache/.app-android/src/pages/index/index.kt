    ...
    companion object {
        ...
        var setup: (__props: GenPagesIndexIndex) -> Any? = fun(__props): Any? {
            ...
            val goToBikeList = fun(){
                uni_navigateTo(NavigateToOptions(url = "/pages/bikelist/bikelist"))
            }
            return fun(): Any? {
                ...
                return _cE(Fragment, null, _uA(
                    ...
                    _cE("view", _uM("class" to "booking-section"), _uA(
                        _cE("button", _uM("class" to "booking-button", "onClick" to goToBikeList), " appoint ")
                    )),
                    _cE("view", _uM("class" to "bottom"), _uA(
                        ...
                        _cV(_component_navigator, _uM("url" to "/pages/me/me", "open-type" to "reLaunch", "hover-class" to "navigator-hover", "class" to "bottom_right"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                            return _uA(
