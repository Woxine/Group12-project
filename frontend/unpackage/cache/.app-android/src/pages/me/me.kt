        ...
        var setup: (__props: GenPagesMeMe) -> Any? = fun(__props): Any? {
            ...
            val getUserInfo = fun(){
                ...
                if (userInfoStr != null && userInfoStr != "" && UTSAndroid.`typeof`(userInfoStr) === "string") {
                    try {
                        val userInfo = UTSAndroid.consoleDebugError(JSON.parse<UserInfo__2>(userInfoStr as String), " at pages/me/me.uvue:111")!!!!
                ...
                val roleRaw = uni_getStorageSync("role")
                        ...
                        _cE("scroll-view", _uM("key" to 1, "class" to "logged-in-container", "scroll-y" to "true"), _uA(
                            ...
                            _cE("view", _uM("class" to "menu-list"), _uA(
                                ...
                                if (userRole.value === "ADMIN") {
                                    _cV(_component_navigator, _uM("key" to 0, "url" to "/pages/admin/home", "open-type" to "navigate", "class" to "menu-item"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                        return _uA(
                                            _cE("text", _uM("class" to "menu-text admin-text"), "Admin Panel"),
                                            _cE("text", _uM("class" to "menu-arrow"), "›")
                                        )
                                    }), "_" to 1))
                                } else {
