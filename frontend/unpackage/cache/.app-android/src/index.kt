...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "192.168.31.201,192.168.23.1,192.168.19.1,127.0.0.1"
    val port: String = "8090"
    val id: String = "app-android_nU7HCe"
    if (hosts == "" || port == "" || id == "") {
...
open class Scooter (
    ...
    open var id: String,
    @JsonNotNull
    open var battery: Number,
    @JsonNotNull
    open var location: String,
) : UTSReactiveObject(), IUTSSourceMap {
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Scooter", "pages/bikelist/bikelist.uvue", 56, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
class ScooterReactiveObject : Scooter, IUTSReactive<Scooter> {
    ...
    override var __v_isShallow: Boolean
    override var __v_skip: Boolean
    constructor(__v_raw: Scooter, __v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean) : super(id = __v_raw.id, battery = __v_raw.battery, location = __v_raw.location) {
        this.__v_raw = __v_raw
        this.__v_isReadonly = __v_isReadonly
        this.__v_isShallow = __v_isShallow
        this.__v_skip = __v_skip
    ...
    override var battery: Number
        get() {
            return _tRG(__v_raw, "battery", __v_raw.battery, __v_isReadonly, __v_isShallow)
        }
        set(value) {
            if (!__v_canSet("battery")) {
                return
            }
            val oldValue = __v_raw.battery
            __v_raw.battery = value
            _tRS(__v_raw, "battery", oldValue, value)
        }
...
val BACKEND_BASE_URL = "http://127.0.0.1:8080"
val buildApiUrl = fun(path: String): String {
    if (path.startsWith("/")) {
...
open class Order (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("Order", "pages/me/me.uvue", 83, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class UserInfo__2 (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("UserInfo", "pages/me/me.uvue", 92, 6)
    }
}
...
open class PaymentInfo (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("PaymentInfo", "pages/payment/payment.uvue", 179, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
