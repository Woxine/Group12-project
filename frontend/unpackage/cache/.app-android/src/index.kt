...
fun initRuntimeSocketService(): UTSPromise<Boolean> {
    val hosts: String = "172.23.96.1,192.168.133.1,192.168.30.1,192.168.16.2,127.0.0.1"
    val port: String = "8090"
    val id: String = "app-android_K3HLh-"
    if (hosts == "" || port == "" || id == "") {
...
open class UserInfo (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("UserInfo", "pages/login/login.uvue", 62, 6)
    }
...
open class FormData (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("FormData", "pages/register/register.uvue", 78, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
...
open class DurationItem (
    ...
    override fun `__$getOriginalPosition`(): UTSSourceMapPosition? {
        return UTSSourceMapPosition("DurationItem", "pages/price/price.uvue", 35, 6)
    }
    override fun __v_create(__v_isReadonly: Boolean, __v_isShallow: Boolean, __v_skip: Boolean): UTSReactiveObject {
