...
public final class ErrorMessages {
    ...
    // Generic API error categories and fallback messages.
    ...
    // Booking and scooter availability errors.
    ...
    // Payment card binding and issuer validation errors.
    public static final String PAYMENT_CARD_NOT_FOUND = "Payment card not found";
    public static final String PAYMENT_CARD_DUPLICATE = "This payment card is already bound.";
    public static final String PAYMENT_CARD_EXPIRED = "Payment card has expired. Please use a valid future expiry date.";
    public static final String PAYMENT_CARD_EXPIRY_MONTH_INVALID = "Expiry month must be between 1 and 12.";
    public static final String PAYMENT_CARD_EXPIRY_YEAR_INVALID = "Expiry year is invalid.";
    public static final String PAYMENT_CARD_NUMBER_FORMAT_INVALID = "Card number must be 13-19 digits.";
    public static final String PAYMENT_CARD_LUHN_INVALID = "Card number failed Luhn check. Please check the digits and try again.";
    public static final String PAYMENT_CARD_BIN_UNSUPPORTED = "Card issuer is not supported by this simulated project. Use a supported test card BIN.";
    public static final String PAYMENT_CARD_BRAND_MISMATCH = "Card brand does not match the simulated issuer validation result. Please select the detected brand and try again.";
    public static final String BIN_LOOKUP_RATE_LIMITED = "Too many BIN lookup requests. Please try again later.";

    // Booking payment and billing guard errors.
    ...
    // Dynamic scooter and booking state messages.
